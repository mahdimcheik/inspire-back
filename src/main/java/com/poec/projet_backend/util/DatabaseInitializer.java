...
public class DatabaseInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        createMentor(new MentorDTO(1L, "Marie", "Delo", "super dev", "Super mentorette", "http://localhost:8080/images/marieD.webp", "git", "link", 1L));
        createMentor(new MentorDTO(2L, "Mathieu", "Dupont", "Data Scientist", "Expert en Data", "http://localhost:8080/images/mat.jpg", "githubJean", "linkedinJean", 2L));
        createMentor(new MentorDTO(3L, "Mahdi", "Martin", "UX Designer", "Créateur d'Expérience", "http://localhost:8080/images/mahdi.jpg", "githubAlice", "linkedinAlice", 3L));
        createMentor(new MentorDTO(4L, "Raph", "Moreau", "DevOps", "Spécialiste en Infrastructure", "http://localhost:8080/images/raph.jpeg", "githubLucas", "linkedinLucas", 4L));
        createMentor(new MentorDTO(5L, "Fred", "Leroy", "Product Manager", "Gestionnaire de Produit", "http://localhost:8080/images/fred.webp", "githubEmma", "linkedinEmma", 5L));
        createMentor(new MentorDTO(6L, "Pilou", "Treuh", "CTO", "Chef d'agence Tech", "http://localhost:8080/images/pilou.jpeg", "githubEmma", "linkedinEmma", 6L));
        createMentor(new MentorDTO(7L, "Orore", "Valixe", "Experte Debug", "Vous êtes ou ??? ", "http://localhost:8080/images/AuroreC.jpg", "githubEmma", "linkedinEmma", 7L));
        createMentor(new MentorDTO(8L, "Angeline", "Leroy", "Développeuse Angular Experte", "Gestionnaire de Produit", "http://localhost:8080/images/Angeline.jpeg", "githubEmma", "linkedinEmma", 8L));
        createMentor(new MentorDTO(9L, "Nassime", "Lemoulin", "Expert Package NPM", "Gestionnaire de package", "http://localhost:8080/images/NassimeC.jpg", "githubEmma", "linkedinEmma", 9L));

        List<Long> mentorids = new ArrayList<>();
        createStudent(new StudentDTO(1L, "Marie", "Delaire", "Dev", "Super Mentorette", "https://picsum.photos/200", "github/mariedelaire", "linkedin/mariedelaire", 10L, mentorids));
        createStudent(new StudentDTO(2L, "Jean", "Dupont", "Data Scientist", "Expert en données", "https://picsum.photos/200", "github/jeandupont", "linkedin/jeandupont", 11L, mentorids));
        createStudent(new StudentDTO(3L, "Alice", "Martin", "UX Designer", "Créatrice d'expériences", "https://picsum.photos/200", "github/alicemartin", "linkedin/alicemartin", 12L, mentorids));
        createStudent(new StudentDTO(4L, "Luc", "Girard", "Backend Developer", "Maître du backend", "https://picsum.photos/200", "github/lucgirard", "linkedin/lucgirard", 13L, mentorids));
        createStudent(new StudentDTO(5L, "Sophie", "Leblanc", "Fullstack Developer", "Génie du Fullstack", "https://picsum.photos/200", "github/sophieleblanc", "linkedin/sophieleblanc", 14L, mentorids));
